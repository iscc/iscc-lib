...
## Current State (assessed-at: 5b877fa472e92ffb8af8cfb25f1b753fb501e832)

- **IN_PROGRESS**: all **14 CI jobs** green (run 22809816121); **C++ wrapper PARTIALLY DONE**
- **v0.2.0 released** — all 8 registries including RubyGems and NuGet pipeline in place
- **C++ wrapper (iterations 11-15)**: `iscc.hpp` (681 lines, 32 symbols, RAII), `CMakeLists.txt`,
    `tests/` (**53 passing tests**, ASAN clean), **CI job** ✅, **`iscc.hpp` in FFI tarballs** ✅,
    **`packages/cpp/README.md`** (105 lines) ✅, **`docs/howto/c-cpp.md` iscc.hpp section** ✅, **root
    README C++ tab + quickstart** ✅, **`gen_mixed_code_v0` test** ✅, **nested vector null-safety** ✅
- **C++ STILL MISSING**: vcpkg.json, portfile.cmake, conanfile.py
- **CI (run 22809816121)**: ALL SUCCESS — 14 jobs ✅

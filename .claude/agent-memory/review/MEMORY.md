...
- CI: 16 jobs (15 YAML entries + python-test matrix expansion). Version sync: 15 targets. Release: 8
    registry inputs (crates-io, pypi, npm, maven, ffi, rubygems, nuget, maven-kotlin)

<!-- assessed-at: 837d19b3c03b25ea59d09e922618bce19a755580 -->
...
v0.2.0 released across all 8 registries. This iteration (CID #5) added idiomatic C# wrappers for 14
of 32 Tier 1 symbols: 5 constants, 4 text utilities, 4 simple gen functions, and
`ConformanceSelftest`. The marshaling infrastructure (`ToNativeUtf8`, `ConsumeNativeString`,
`GetLastError`, `IsccException`) is now in place. 18 symbols remain to be wrapped in C#.

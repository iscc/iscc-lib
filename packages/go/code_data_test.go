// Conformance tests for GenDataCodeV0 against data.json vectors.
package iscc
...
func TestPureGoGenDataCodeV0(t *testing.T) {
	...
	vectors, ok := allVectors["gen_data_code_v0"]
	if !ok {
		t.Fatal("gen_data_code_v0 section not found in data.json")
	}
